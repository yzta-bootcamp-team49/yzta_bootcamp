...
declare const _default: React.FC<TabProps> & {
    Container: {
        ({ transition, ...props }: import("react-bootstrap/esm/TabContainer").TabContainerProps): import("react/jsx-runtime").JSX.Element;
        propTypes: {
    ...
    Content: import("react-bootstrap/esm/helpers").BsPrefixRefForwardingComponent<"div", import("react-bootstrap/esm/TabContent").TabContentProps>;
